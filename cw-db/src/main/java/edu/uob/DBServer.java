...
public final class DBServer {
  ...
  public DBServer(File databaseDirectory) {
    ...
    directoryPath = databaseDirectory.getPath();
  ...
  public String handleCommand(String command){
    ...
    SQLParser parse = new SQLParser();
     try{
       DBcmd interpreter;
       if(parse.parser(command, databaseUsing, directoryPath)) {
          interpreter = parse.getInterpreter();
          databaseUsing = interpreter.getDatabaseUsing();
        }else{
          return "[ERROR] Invalid query.";
        }
       String result = interpreter.getResult();
       return "[OK]\n" + result;
